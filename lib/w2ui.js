...
(function ($) {
    ...
    w2grid.prototype = {
        ...
        buttons: {
            ...
            'edit'     : { type: 'button', id: 'w2ui-edit', text: 'Edit', tooltip: 'Edit selected record', icon: 'w2ui-icon-pencil', disabled: false },
        ...
        editField: function (recid, column, value, event) {
            var obj = this;
            if (this.last.inEditMode === true && event != null) { // already editing
                if (event.keyCode == 13) {
                    alert('Enter!');
